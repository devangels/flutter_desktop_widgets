...
import 'dart:ui' as ui show window, PointerDataPacket, PointerData, PointerChange;

import 'package:flutter/foundation.dart';
import 'package:flutter/src/desktop/hover_manager.dart';
...
//class GestureBinding extends BindingBase implements HitTestable, HitTestDispatcher, HitTestTarget {
  ...
  HoverManager get hoverManager => _hoverManager;
  ...
  void initInstances() {
    ...
    _methodChannel.setMethodCallHandler((MethodCall call) {
      if(call.method == 'onPositionChanged') {
        ...
        final ui.PointerData data = ui.PointerData(
          physicalX: physicalX,
          physicalY: physicalY,
          timeStamp: timeStamp,
          change: ui.PointerChange.hover,
        );
        _handlePointerDataPacket(ui.PointerDataPacket(data: <ui.PointerData>[data]));
      }
    });
  }
  ...
  void _handlePointerEvent(PointerEvent event) {
    ...
    if (event is PointerDownEvent) {
      ...
      _hoverManager.handleHover(event);
      return;
    } else {
